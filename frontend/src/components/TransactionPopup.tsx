...
function TransactionPopup({ title, balance, categoryId, setBalance, setCategoryId, setIsPopupOpen, handleSubmit, isSubmitting }: TransactionPopupProps) {
                ...
                <form onSubmit={handleSubmit} className="space-y-3 pt-4 pb-2">
                    <section className="space-y-1">
                        ...
                        <select 
                            ...
                            className="bg-white block w-full border-2 border-[#CBCBCB] rounded-lg text-sm p-0.5 md:p-1 md:text-base"
                        >
